...
# it to ThermoSourceHubConfig before resolving sources. The selected source is
# always stored in "src"; "mode" is inferred.

# NOTE: Tc uses string shorthand, so source is "model_source".
