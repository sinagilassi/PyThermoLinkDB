...
# NOTE:
# build_thermo_source_hub() accepts YAML/JSON string content for both
# model_source_config and custom_source_config. register_thermo_source()
# accepts YAML/JSON string content for thermo_source_hub_config.
...
cp_ig_source_type = parsed_config["Cp_IG"].source
